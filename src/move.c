...
{
	if (cub->map[(int)(cub->player.y + dir_y * 0.1)][(int)cub->player.x] != '1')
		cub->player.y += dir_y * 0.1;
	if (cub->map[(int)cub->player.y][(int)(cub->player.x + dir_x * 0.1)] != '1')
		cub->player.x += dir_x * 0.1;
}
